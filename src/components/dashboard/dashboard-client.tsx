        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-white rounded-lg shadow-sm p-6 border border-gray-200">
              ...
              <p className="text-3xl font-bold text-gray-900">{routinesCount}</p>
              <p className="text-sm text-gray-500 mt-1">Available routines</p>
            </div>
            <div className="bg-white rounded-lg shadow-sm p-6 border border-gray-200">
              <h3 className="text-sm font-semibold uppercase tracking-wider text-gray-400 mb-2">
                Total Recipes
              ...
              <p className="text-sm text-gray-500 mt-1">Available recipes</p>
            </div>
          </div>
