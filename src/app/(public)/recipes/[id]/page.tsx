...
export default async function RecipeDetailPage({
  ...
  const recipe = recipeResult.data as RecipeWithDetails & {
  ...
  const recipeNameWords = recipe.name
    .toLowerCase()
    .split(/\s+/)
  ...
  return (
    <div className="container mx-auto max-w-6xl p-6">
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="mb-3 text-sm leading-relaxed text-gray-700">
                    Varför fungerar detta? Lär dig den kemiska vetenskapen bakom
                    denna teknik.
                  </p>
                  <Link
      ...
      {/* Admin Actions */}
      {isAdmin && <RecipeDetailClient recipeId={recipe.id} />}
    </div>
  );
}
